const constants = {
    //Syntax of a constant reducer-name:action-name
    ...
    //USER CONSTANTS
        ...
        FETCH_USER_TEAMS_START: 'FETCH_USER_TEAMS_START',
        FETCH_USER_TEAMS_SUCCESS: 'FETCH_USER_TEAMS_SUCCESS',
        FETCH_USER_TEAMS_FAILURE: 'FETCH_USER_TEAMS_FAILURE',

        //GET fetch teams for user

        FETCH_USER_VIDEOS_START: 'FETCH_USER_VIDEOS_START',
        FETCH_USER_VIDEOS_SUCCESS: 'FETCH_USER_VIDEOS_SUCCESS',
        FETCH_USER_VIDEOS_FAILURE: 'FETCH_USER_VIDEOS_FAILURE',
